    ...
    def print_tree(self, node, level=0, prefix="Root: "):
        ...
        if node is not None:
            ...
            if node.right is not None: 
                BinarySearchTree.print_tree(node.right, level + 1, prefix=" |- Правый узел: ")

            if node.left is not None: 
                BinarySearchTree.print_tree(node.left, level + 1, prefix=" |- Левый узел: ")
    ...
    def run(self):
         ...
         while True:
             ...
             if action == "1":
                 ...
                 message = "Узел с таким значением найден" if found_node else "Узел с таким значением не найден."
                 print(message)
