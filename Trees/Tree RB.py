    ...
    def print_tree(self, node, level=0, prefix="Root: "):
         if node !=self.NIL_LEAF:
             ...
             if node.right !=self.NIL_LEAF: 
                 RedBlackTree.print_tree(node.right, level +1 , prefix=" |- Правый узел: ")

             if node.left !=self.NIL_LEAF: 
                 RedBlackTree.print_tree(node.left, level +1 , prefix=" |- Левый узел: ")
    ...
    def run(self):
         while True:
             ...
             if action=="1":
                 ...
                 message="Узел с таким значением найден"if found_node!=self.tree.NIL_LEAF else"Узел с таким значением не найден"
                 print(message)
